...
function inp_1() {
    ...
    if (lista_respostas[0] == 'CPU') {
        ...
        <h4>
            ...
            <input id="input_2" type="text" oninput="inp_2()">
...
function inp_2() {
    ...
    if (lista_respostas[1] == 'ULA') {
        ...
        <h4>
            ...
            <input id="input_3" type="text" oninput="inp_3()">

            
        </h4>  <br>
        `
    } else if (lista_respostas[1] == '') {
...
function inp_3() {
    ...
    if (lista_respostas[2] == 'ADDRESS BUS') {
        ...
        <h4>
            ...
            <input id="input_4" type="text" oninput="inp_4()">
           
        </h4> > <br>
        `
    } else if (lista_respostas[2] == '') {
...
function inp_4() {
    ...
    if (lista_respostas[3] == 'REGISTRADORES') {
        ...
        <h4>
            ...
            <input id="input_5" type="text" oninput="inp_5()">
            
        </h4> <br>

        `
    } else if (lista_respostas[3] == '') {
...
function inp_5() {
    ...
    if (lista_respostas[4] == 'RAM') {
        ...
        <h4>
            ...
            <input id="input_6" type="text" oninput="inp_6()">
        </h4> <br>
        `
    } else if (lista_respostas[4] == '') {
...
function inp_6() {
    ...
    if (lista_respostas[5] == 'ROM') {
        ...
        Qual é o nome de uma linha popular de processadores da Intel lançada em 2008, que inclui modelos como o ____-9700K e o ____-10700K?
            <input id="input_7" type="text" oninput="inp_7()">
        </h4><br> 
        `
    } else if (lista_respostas[5] == '') {
...
function inp_7() {
    ...
    if (lista_respostas[6] == 'I7') {
        ...
        <input id="input_8" type="text" oninput="inp_8()">
        </h4>
        `;



    } else if (lista_respostas[6] == '') {
...
function inp_8() {
    ...
    if (lista_respostas[7] == 'FLASH') {
        ...
        <input id="input_9" type="text" oninput="inp_9()">
        </h4>
        `;
    } else if (lista_respostas[7] == '') {
...
function inp_9() {
    ...
    if (lista_respostas[8] == 'DUAL CORE') {
        ...
        <input id="input_10" type="text" oninput="inp_10()">
        </h4>
        `;
    } else if (lista_respostas[8] == '') {
...
function inp_10() {
    ...
    if (lista_respostas[9] == 'MEMÓRIA DE MASSA') {
       ...
       _______ é um conjunto de fios que transporta os próprios dados entre a CPU e a memória ou dispositivos de E/S.
        <input id="input_11" type="text" oninput="inp_11()">
        </h4>
        `;

    } else if (lista_respostas[9] == '') {
...
function inp_11() {
    ...
    if (lista_respostas[10] == 'DATA BUS') {
        ...
        <input id="input_12" type="text" oninput="inp_12()">
        </h4>
        `
    } else if (lista_respostas[10] == '') {
...
function inp_12() {
    ...
    if (lista_respostas[11] == 'QUAD CORE') {
        ...
        <input id="input_13" type="text" oninput="inp_13()">
        </h4>
        `;

    } else if (lista_respostas[11] == '') {
...
function inp_13() {
    ...
    if (lista_respostas[12] == 'DMA') {
        ...
        <input id="input_14" type="text" oninput="inp_14()">
        `;

    } else if (lista_respostas[12] == '') {
...
function inp_14() {
    ...
    if (lista_respostas[13] == 'I5') {
        ...
        <input id="input_15" type="text" oninput="inp_15()">
        </h4>
        `;

    } else if (lista_respostas[13] == '') {
...
function inp_15() {
    ...
    if (lista_respostas[14] == 'EPROM') {
        ...
        <input id="input_16" type="text" oninput="inp_16()">
        </h4>
        `;

    } else if (lista_respostas[14] == '') {
...
function inp_16() {
    ...
    if (lista_respostas[15] == 'THREADS') {
        ...
        <input id="input_17" type="text" oninput="inp_17()">
        </h4>
        `;

    } else if (lista_respostas[15] == '') {
...
function inp_17() {
    ...
    if (lista_respostas[16] == 'CS') {
        ...
        <input id="input_18" type="text" oninput="inp_18()">
        </h4>
        `;
